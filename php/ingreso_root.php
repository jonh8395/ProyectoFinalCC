...
<html>
	<head>
		<title>Ingresar como Root</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
							...
							<div class="wrapper">
								<div class="inner">
									...
									<section id="footer">
                                        ...
                                        <form action="ingreso_u.php" method="POST"  onsubmit="return verificarRoot()" name="form">
											 ...
											 <div class='fields'>
										         <div class='field'>
													...
													<div class="field">
														...
														<input type="password" name="ClaveU" id="ClaveU" / autocomplete="off">
                                                    </div>
                                                    
													<div class='field'>
													 <div class="col-12 col-12-small">
													<input type="checkbox" id="demo-copy" name="demo-copy" onclick="myFunction()">
													<label for="demo-copy">Mostrar password</label>
													</div>
													</div>
		...
		<!-- Scripts -->
			...
			<script src="../js/script_mouse.js"></script>
	</body>
</html>