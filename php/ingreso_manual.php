...
<html>
	<head>
		<title>Entrada/Salida Manual de Empleado</title>
		<meta charset="utf-8" />
			...
			<div id="page-wrapper">
				...
				<!-- Wrapper -->
					<section id="wrapper">
						<header>
							<div class="inner">
								<h2>Entrada/Salida Manual de Empleado</h2>
								<p>Vector s.a</p>
							</div>
						</header>
								...
								<div class="inner">
									...
									<section id="footer">
										...
										<div class="inner">
											...
											<form action="insertar_manual.php" method="POST"  onsubmit="return verificadorManual();" name="form">
