								...
								<li>
									<div class="dropdown4">
										...
										<div class="dropdown4-content-cinco">
											<a href="./php/ingreso_root.php">Ingreso</a>
											<a href="./php/ingreso_root2.php">Consultar</a>
										</div>
									</div>
								</li>
								<br><br><br>
							...
							<div class="wrapper">
								<div class="inner">
									...
									<section id="footer">
                                        ...
                                        <form action="insertar_u.php" method="POST"  onsubmit="return verificador()" name="form">
											 ...
											 <div class='fields'>
										         <div class='field'>
													...
													<div class="field">
														...
														<input type="text" name="ClaveU" id="ClaveU" maxlength="50" />
                                                    </div>
